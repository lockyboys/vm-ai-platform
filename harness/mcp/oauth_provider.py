# =============================================================================
# File Name   : harness/mcp/oauth_provider.py
# Purpose     : 로그인한 사람만 Harness를 쓰게 하는 보안 도구
# =============================================================================
# CHANGE HISTORY
# =============================================================================
...
# - 통과한 사람에게만 Harness 명령어를 쓸 수 있는 임시 출입증을 발급합니다.
# 주의: 비밀번호·토큰·비밀키는 화면이나 로그에 그대로 남기지 않습니다.
