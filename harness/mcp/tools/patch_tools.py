# =============================================================================
# File Name   : harness/mcp/tools/patch_tools.py
# Purpose     : 지정한 파일만 고치고, 이름을 바꾸거나 삭제하는 도구
# =============================================================================
# CHANGE HISTORY
# =============================================================================
# 20260902 | Codex | Harness 표준 파일 헤더와 변경 안전 경계 설명을 보강했음
# =============================================================================
# 이 파일은 무엇을 하나요?
# - source_patch는 필요한 줄만 바꾸고, source_rename은 파일 이름을 바꿉니다.
# - source_delete는 Git이 관리하는 파일 한 개만 삭제합니다.
# 주의: 폴더 전체 삭제, 프로젝트 밖 변경, 추적하지 않는 파일의 위험한 삭제는 막습니다.
