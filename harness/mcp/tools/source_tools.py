# =============================================================================
# File Name   : harness/mcp/tools/source_tools.py
# Purpose     : 프로젝트 파일을 안전하게 찾고 읽는 도구
# =============================================================================
# CHANGE HISTORY
# =============================================================================
# 20260902 | Codex | Harness 표준 파일 헤더와 조회 안전 경계 설명을 보강했음
# =============================================================================
# 이 파일은 무엇을 하나요?
# - source_search는 원하는 단어가 들어 있는 파일과 줄 번호를 찾습니다.
# - source_read는 지정한 파일의 내용을 줄 번호와 함께 보여 줍니다.
# 주의: 프로젝트 밖의 파일, 비밀값이 들어 있을 수 있는 실행 폴더는 읽지 않습니다.
